    ...
    <div id="case-studies-page-root" className="space-y-16 pt-10 pb-16">
      ...
      <section id="case-studies-header" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center sm:text-left space-y-4">
        ...
        <h1 className="font-display text-3xl sm:text-5xl font-extrabold text-white tracking-tight max-w-3xl">
          Audited Outcomes, Decoupled From Hype
        </h1>
        <p className="font-sans text-sm sm:text-base text-slate-400 max-w-2xl leading-relaxed">
          We prove our results mathematically. Read how leading UK manufacturing SMEs eliminated setup bottlenecks, slashed material scrap, and recovered floor capacity within weeks of pilot deployment.
        </p>
      </section>
          ...
          >
            ...
            <div className="lg:col-span-7 space-y-5">
              <div className="flex flex-wrap items-center gap-2">
                <span className="font-mono text-[9px] text-teal-400 font-bold bg-teal-500/10 px-2 py-0.5 rounded border border-teal-500/20 uppercase">
                  {study.industry}
                </span>
              ...
              <div className="space-y-3.5 pt-2">
                <div>
                  <h4 className="font-mono text-[9px] text-slate-500 uppercase font-bold tracking-wider mb-1">The Challenge</h4>
                  <p className="font-sans text-xs sm:text-sm text-slate-400 leading-relaxed">
                    {study.challenge}
                  </p>
                </div>
                <div>
                  <h4 className="font-mono text-[9px] text-slate-500 uppercase font-bold tracking-wider mb-1">The Inshira Implementation</h4>
                  <p className="font-sans text-xs sm:text-sm text-slate-400 leading-relaxed">
                    {study.solution}
                  </p>
                </div>
              ...
              {/* Operations director quote quote box */}
              <div className="bg-slate-950 p-4 rounded-xl border border-slate-850/80 relative space-y-2">
                ...
                <div className="flex items-center gap-2.5 pt-1">
                  ...
                  <span className="font-mono text-[9px] text-slate-500 uppercase">{study.quote.role}, {study.client}</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 bg-slate-950 rounded-xl border border-slate-850 p-6 flex flex-col justify-between h-full space-y-6">
              <div className="space-y-4">
                <div className="flex items-center gap-1.5 border-b border-slate-900 pb-3">
                  ...
                  <span className="font-display text-xs font-bold text-white uppercase tracking-wider">Audited Success Metrics</span>
                </div>

                <div className="space-y-4">
                  <div>
                    <span className="font-mono text-[9px] text-slate-500 uppercase tracking-wider block">Downtime Reduction</span>
                    <span className="font-display text-lg sm:text-xl font-bold text-teal-400 block mt-0.5">
                      {study.results.downtimeReduction}
                    </span>
                  </div>

                  <div>
                    <span className="font-mono text-[9px] text-slate-500 uppercase tracking-wider block">Material Yield Efficiency</span>
                    <span className="font-display text-lg sm:text-xl font-bold text-teal-400 block mt-0.5">
                  ...
                  <div>
                    <span className="font-mono text-[9px] text-slate-500 uppercase tracking-wider block">Audited Savings / Yr</span>
                    <span className="font-display text-lg sm:text-2xl font-extrabold text-white block mt-0.5">
              ...
              <div className="pt-4 border-t border-slate-900 flex justify-between items-center text-[11px] font-mono">
                <span className="text-slate-500 uppercase">Payback Period:</span>
                <span className="text-emerald-400 font-bold bg-emerald-500/10 px-2.5 py-1 rounded border border-emerald-500/10">
                  {study.results.paybackPeriod} Payback
                </span>
              </div>
            </div>
          </div>
      ...
      <section id="case-studies-cta" className="max-w-3xl mx-auto px-4 text-center space-y-6">
        <h3 className="font-display text-lg sm:text-xl font-bold text-white">
          Secure Comparable Outcomes for Your Factory
        </h3>
        <p className="font-sans text-xs text-slate-400 leading-relaxed">
          Our pilots have 100% success rate. Schedule a diagnostic session to model your exact line parameters and determine your potential recovery numbers before connecting live data pipelines.
        </p>
        <button
          onClick={onCtaClick}
